           ...
           if (token->getNext() != nullptr && token->getNext()->getNext() != nullptr && token->getNext()->getStringRep() == ":") //which imply it is a vector
            {
                if (token->details==nullptr) //initialize token detail
                    token->details=new tokenDetails;
                //Set detail type
                token->details->type = token->getNext()->getNext()->getStringRep();
                
                //Find width
                if (token->getNext()->getNext()->getNext() != nullptr && token->getNext()->getNext()->getNext()->getStringRep() == "(" &&token->getNext()->getNext()->getNext()->getNext() != nullptr && token->getNext()->getNext()->getNext()->getNext()-> getNext() != nullptr && token->getNext()->getNext()->getNext()->getNext()-> getNext()->getNext() != nullptr)
                {
