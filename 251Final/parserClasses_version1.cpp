...
void TokenList::findAndSetTokenDetails(Token *token){
    ...
    //traverse for std_logig e.g. '0','1'
    else if ((token->stringRep).find_first_of("\'")==0 && (token->stringRep).find_first_of("\'")==2){
